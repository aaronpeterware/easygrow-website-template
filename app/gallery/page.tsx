    ...
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-4">Contact our expert team for a free quote and exceptional results</p>
          </div>
      ...
      <section className="py-16 bg-gray-900 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-300 mb-8">Contact us today for a free quote and let us deliver exceptional results.</p>
